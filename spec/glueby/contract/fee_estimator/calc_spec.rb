RSpec.describe 'Glueby::Contract::FeeEstimator::Calc' do
  describe '#fee' do
    subject { Glueby::Contract::FeeEstimator::Calc.new.fee(tx) }
    ...
    context 'if specify fee_rate' do
      subject { Glueby::Contract::FeeEstimator::Calc.new(fee_rate: 100).fee(tx) }
    ...
    context 'default_fee_rate is specified' do
      before do
        Glueby::Contract::FeeEstimator::Calc.default_fee_rate = 600
      end
